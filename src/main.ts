...
let trackContainer = document.querySelector(".time-track") as HTMLDivElement;
...
function createTimeTracks(tracks:TimeTrack[]) {
    tracks.forEach((track:TimeTrack, index:number) => {
        // create trackBox div
...
function filterTimeTracks(tracks: TimeTrack[], periods: any[] | NodeListOf<Element>): void {
